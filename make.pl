...
my $default_libraries    = "-l$project -lm -lncurses -lpthread -lrt ";
...
sub libs{
    ...
    my $build_cmd    = "g++ -c *.cpp $optimize $warnings $libraries "
...
sub build{
    ...
    my $build_string = "g++ test/main.cpp $lib_string $optimize $warnings "
